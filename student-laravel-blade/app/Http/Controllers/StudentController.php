...
class StudentController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect()->route("student.index")->with("success","Student info successfully updated");
    ...
    public function destroy(Request $request, $id)
    {
        try {
            ...
            return redirect()->route('student.index')->with('success', "Student $student->student deleted successfully.");
